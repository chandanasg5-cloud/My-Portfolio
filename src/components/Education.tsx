    ...
    <section id="education" style={{ padding: '5rem 2rem', background: 'var(--bg-soft)' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gap: '1rem' }}>
          {education.map((edu, i) => (
            <div key={i} style={{ background: 'white', border: '1px solid var(--border-color)', borderRadius: 10, padding: '1.25rem 1.5rem', display: 'flex', alignItems: 'flex-start', gap: '1rem' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '0.8375rem', color: 'var(--muted-color)' }}>{edu.school}{edu.year ? ` — ${edu.year}` : ''}</div>
